...
function App() {
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* منطقة الهوية - لوجو مربع بحواف منحنية */}
      ...
      {isLoggedIn ? (
        ...
        <div style={socialGrid}>
          ...
          {/* تيك توك */}
          <a href="https://tiktok.com/@shoqaq.ramallah" target="_blank" rel="noreferrer" style={{...iconBox, background: 'linear-gradient(135deg, #222 0%, #000 100%)', border: '1px solid rgba(255,255,255,0.1)'}} title="تيك توك">
...
const logoImg = { width: '120px', height: '120px', objectFit: 'cover' };

const mainTitle = { fontSize: '3.2rem', fontWeight: '900', margin: '15px 0 0 0' };
const subTitle = { color: '#888', marginTop: '8px', fontSize: '1.1rem' };
...
const footerText = { position: 'fixed', bottom: '20px', opacity: 0.1, fontSize: '11px', color: '#888' };
