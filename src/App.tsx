...
export default function App() {
  ...
  return (
    <div style={{ ...s.container, backgroundColor: theme.bg, color: theme.text }}>
            ...
            <div style={s.grid}>
              {[
                ...
                },
                {
                  ...
                  icon: <Phone size={24} color="#34A853" strokeWidth={1.5} />,
                },
                {
                  href: 'https://instagram.com/shoqaq.ramallah/',
                  icon: <Instagram size={24} color="#e1306c" strokeWidth={1.5} />,
                },
              ].map((item, index) => (
                <a
                  key={index}
          ...
          >
            <div style={s.adminHeader}>
              ...
              <button
                ...
                style={{ ...s.logoutBtn, color: theme.subText }}
              >
                <LogOut size={22} />
              </button>
            </div>

            <button style={{ ...s.adminAction, color: theme.text, borderColor: theme.border }}>
      ...
      <footer style={{ ...s.footer, color: theme.subText }}>
        SHOQAQ.STORE • 2026
      </footer>
    </div>
  );
