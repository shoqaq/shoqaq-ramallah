  ...
  return (
    <div style={{...s.container, backgroundColor: theme.bg, color: theme.text}}>
      ...
      <div style={s.mainWrapper}>
        ...
        {!isLoggedIn && (
          /* أيقونات التواصل - قريبة جداً من النص أعلاها */
          <div style={s.grid}>
...
const s = {
  ...
  mainWrapper: {
    ...
    alignItems: 'center',
    width: '100%',
    marginTop: '-10vh', // رفع المحتوى قليلاً للأعلى عن المنتصف
  },
  ...
  identity: { textAlign: 'center', marginBottom: '8px', display: 'flex', flexDirection: 'column', alignItems: 'center' }, // هامش سفلي صغير جداً
  ...
  grid: { display: 'flex', gap: '10px', marginBottom: '40px' }, // الأيقونات قريبة جداً من الجملة أعلاها، ومسافة أمان قبل أزرار الخدمات
