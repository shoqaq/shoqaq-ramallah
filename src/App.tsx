...
import { 
  ...
  Building2, ClipboardEdit, Plus, Sun, Moon, Lock, X, Save, Trash2, ChevronRight 
} from 'lucide-react';

// --- إعدادات الربط (المحرك الخلفي) ---
      ...
      <div style={s.mainWrapper}>
        ...
        {!isLoggedIn && !showLogin && (
          <>
            ...
            {/* أزرار الخدمات الكبيرة بنقوشها الأصلية */}
            <div style={s.services}>
              {[
                ...
                <button key={i} style={{ ...s.serviceCard, backgroundColor: theme.cardBg, border: `2px solid ${theme.border}`, boxShadow: theme.shadow, color: theme.text }}>
                  {item.icon}
        ...
        {isLoggedIn && (
          <div style={{ ...s.adminPanel, border: `2px solid ${theme.border}`, backgroundColor: theme.cardBg, boxShadow: theme.shadow }}>
             {adminView === 'main' ? (
               ...
               <div>
                 <div style={s.adminHeader}><h3>القائمة</h3> <X onClick={() => setAdminView('main')} style={{ cursor: 'pointer' }} /></div>
