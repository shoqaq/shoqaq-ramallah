      ...
      {isLoggedIn ? (
        <div style={adminPanel}>
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px' }}>
            ...
            <button onClick={() => setIsLoggedIn(false)} style={logoutBtn}><LogOut size={20} /></button>
          </div>
        ...
        <div style={socialGrid}>
          ...
          {/* اتصال */}
          <a href="tel:+970594560056" style={{...iconBox, background: '#34A853'}}><Phone size={24} color="white" strokeWidth={1.5} /></a>
          {/* فيسبوك */}
          <a href="https://facebook.com/shoqaq.store/" target="_blank" rel="noreferrer" style={{...iconBox, background: '#1877F2'}}><Facebook size={24} color="white" strokeWidth={1.5} /></a>
          {/* انستغرام */}
          <a href="https://instagram.com/shoqaq.ramallah/" target="_blank" rel="noreferrer" style={{...iconBox, background: 'linear-gradient(45deg, #f09433 0%, #e6683c 50%, #bc1888 100%)'}}><Instagram size={24} color="white" strokeWidth={1.5} /></a>
          {/* تيك توك الرسمي */}
...
const logoWrapper = { cursor: 'pointer', marginBottom: '10px', borderRadius: '24px', overflow: 'hidden', display: 'flex', boxShadow: '0 0 30px rgba(245,158,11,0.1)', border: '1px solid rgba(255,255,255,0.05)' };
...
const socialGrid = { display: 'flex', gap: '12px', justifyContent: 'center', marginTop: '20px' };
const iconBox = { width: '50px', height: '50px', borderRadius: '15px', display: 'flex', alignItems: 'center', justifyContent: 'center', textDecoration: 'none', boxShadow: '0 4px 15px rgba(0,0,0,0.5)' };
const loginInput = { backgroundColor: '#050505', border: '1px solid #111', borderRadius: '12px', padding: '12px', color: '#f59e0b', textAlign: 'center', width: '180px' };
const adminPanel = { backgroundColor: '#050505', padding: '25px', borderRadius: '24px', width: '320px', border: '1px solid #111' };
const adminAction = { width: '100%', padding: '12px', marginBottom: '10px', borderRadius: '12px', backgroundColor: '#0a0a0a', border: '1px solid #111', color: 'white', textAlign: 'right', display: 'flex', alignItems: 'center', gap: '10px' };
