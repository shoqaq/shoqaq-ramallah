...
function App() {
  ...
  // رابط اللوجو الخاص بك على GitHub (استخدمنا النسخة الخام 'raw' لتعمل كصورة)
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* منطقة الهوية - باستخدام اللوجو الخاص بك */}
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        <div 
          onClick={() => { setShowLogin(!showLogin); setPassword(""); }}
          style={logoContainerStyle}
        >
          {/* عرض صورة اللوجو بدلاً من الأيقونة */}
          <img 
            src={logoUrl} 
            alt="شقق رام الله" 
        ...
        <h1 style={{ fontSize: '3.5rem', fontWeight: '900', margin: '15px 0 0 0', color: '#1a1a1a' }}>
...
// --- التنسيقات المعدلة للوجو الخاص بك ---
...
const logoContainerStyle = {
  backgroundColor: '#fff', // خلفية بيضاء للوجو
  borderRadius: '40px', // زوايا ناعمة للحاوية
  overflow: 'hidden', // لضمان بقاء الصورة داخل الزوايا
  marginBottom: '10px',
...
const logoImageStyle = {
  ...
  height: '120px', // ارتفاع الصورة (لجعلها مربعة)
  objectFit: 'cover' as const, // لضمان عدم تشوه الصورة
  borderRadius: '35px' // زوايا الصورة نفسها لتبدو ناعمة
};
