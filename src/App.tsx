...
import { Phone, Facebook, Instagram, LogOut, PlusCircle, LayoutDashboard, Building2, ClipboardEdit, HomePlus } from 'lucide-react';
...
export default function App() {
  ...
  return (
    <div style={s.container}>
      {/* 1. القسم العلوي: اللوجو والعنوان */}
      ...
      {/* 2. قسم التواصل الاجتماعي: تحت العنوان مباشرة */}
      {!isLoggedIn && (
        <div style={s.grid}>
          ...
          <a href="tel:+970594560056" style={{...s.box,background:'#34A853'}}><Phone size={20} color="white"/></a>
          <a href="https://facebook.com/shoqaq.store/" style={{...s.box,background:'#1877F2'}}><Facebook size={20} color="white"/></a>
          <a href="https://instagram.com/shoqaq.ramallah/" style={{...s.box,background:'linear-gradient(45deg,#f09433,#e6683c,#bc1888)'}}><Instagram size={20} color="white"/></a>
          <a href="https://tiktok.com/@shoqaq.ramallah" style={{...s.box,background:'#000',border:'1px solid #222'}}>
            <svg width="22" height="22" fill="white" viewBox="0 0 24 24"><path d="M19.59 6.69a4.83 4.83 0 0 1-3.77-4.25V2h-3.45v13.67a2.89 2.89 0 0 1-5.2 1.74 2.89 2.89 0 0 1 2.31-4.64 2.93 2.93 0 0 1 .88.13V9.4a6.84 6.84 0 0 0-1-.05A6.33 6.33 0 0 0 5 20.1a6.34 6.34 0 0 0 10.86-4.43v-7a8.16 8.16 0 0 0 4.77 1.52v-3.4a4.85 4.85 0 0 1-1.04-.1z"/></svg>
          </a>
        </div>
      )}
      ...
      {isLoggedIn ? (
        ...
        <div style={s.services}>
          ...
          <button style={s.serviceCard}>
            <ClipboardEdit size={28} color="#f59e0b" />
            <span style={s.serviceText}>تقديم طلب</span>
          </button>

          <button style={{...s.serviceCard, border:'1px dashed #f59e0b'}}>
...
const s = {
  container: { backgroundColor:'#000', color:'white', minHeight:'100vh', display:'flex', flexDirection:'column', alignItems:'center', direction:'rtl', fontFamily:'sans-serif', padding:'40px 20px' },
  identity: { textAlign:'center', marginBottom:'20px' },
  logoWrap: { cursor:'pointer', marginBottom:'15px', borderRadius:'18px', overflow:'hidden', display:'inline-block', border:'1px solid #333', width:'90px', height:'90px', boxShadow:'0 5px 15px rgba(245,158,11,0.1)' },
  logoImg: { width:'100%', height:'100%', objectFit:'cover', display:'block' },
  title: { fontSize:'1.8rem', fontWeight:'900', margin:'5px 0 0 0' },
  sub: { color:'#888', marginTop:'8px', fontSize:'1.1rem' },
  
  grid: { display:'flex', gap:'10px', justifyContent:'center', marginBottom:'40px' },
  box: { width:'42px', height:'42px', borderRadius:'12px', display:'flex', alignItems:'center', justifyContent:'center', textDecoration:'none' },

  services: { display:'flex', flexDirection:'column', gap:'12px', width:'100%', maxWidth:'340px', marginTop:'20px' },
  serviceCard: { 
    display:'flex', alignItems:'center', gap:'15px', padding:'18px', 
    backgroundColor:'#070707', border:'1px solid #151515', borderRadius:'14px',
    cursor:'pointer', textAlign:'right', width:'100%'
  },
  serviceText: { color:'white', fontSize:'1rem', fontWeight:'600' },
  ...
  admin: { backgroundColor:'#050505', padding:'20px', borderRadius:'20px', width:'300px', border:'1px solid #111', marginTop:'20px' },
