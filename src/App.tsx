...
function App() {
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* منطقة الهوية - كما في الصورة (V 1.1) */}
      ...
      {isLoggedIn ? (
        ...
        /* أزرار التواصل - دائرية وملونة (كما في الصورة) */
...
const logoWrapper = {
  cursor: 'pointer',
  marginBottom: '10px',
  borderRadius: '50%', // دائري بالكامل (كما في الصورة)
  overflow: 'hidden',
  display: 'flex',
  alignItems: 'center',
  justifyContent: 'center',
...
const iconBox = {
  width: '70px',
  height: '70px',
  borderRadius: '50%', // دائرية بالكامل (كما في الصورة)
  display: 'flex',
  alignItems: 'center',
  justifyContent: 'center',
  textDecoration: 'none',
