    ...
    <div style={containerStyle}>
      ...
      {isLoggedIn ? (
        ...
        <div style={socialGrid}>
          <a href={whatsappChannelLink} target="_blank" rel="noreferrer" style={{...iconBox, background: '#25D366'}}>
...
// التعديل هنا: ضمان تناسق اللوجو
const logoWrapper = { 
    cursor: 'pointer', 
    marginBottom: '10px', 
    borderRadius: '20px', // تقليل الانحناء قليلاً ليعطي شكلاً أفخم
    overflow: 'hidden', 
    display: 'inline-block', // يضمن أن الحاوية تأخذ حجم الصورة
    boxShadow: '0 8px 30px rgba(245,158,11,
