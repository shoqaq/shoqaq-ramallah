...
export default function App() {
  ...
  // تعديل وظيفة الحفظ للبقاء في نفس الشاشة
  const handleSave = async () => {
    ...
    if (!error) {
      // تصفير النص فقط للبقاء وجاهزية الإدخال الجديد
      setNewProperty({ ...newProperty, property_name: '' }); 
      fetchListings();
      // ملاحظة: لم نغير adminView إلى 'main' لكي تبقى في شاشة الإضافة
    }
  };
            ...
            {adminView === 'main' ? (
              ...
              <div>
                ...
                <input 
                   ...
                   placeholder="اكتب اسم العقار هنا..." 
                ...
                <p style={{ fontSize: '0.8rem', marginTop: '10px', color: '#34A853', textAlign: 'center' }}>سيتم الحفظ والبقاء في هذه الشاشة</p>
              </div>
            ) : (
              <div>
...
const s = {
  ...
  serviceCard: { display: 'flex', alignItems: 'center', gap: '20px', padding: '22px 24px', borderRadius: '22px', cursor: 'pointer' },
