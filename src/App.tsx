...
function App() {
  ...
  // رابط اللوجو الخاص بك من GitHub
  ...
  return (
    <div style={containerStyle}>
      ...
      {/* منطقة الهوية - الثيم الأسود الفخم */}
      <div style={{ textAlign: 'center', marginBottom: '40px' }}>
        ...
        <h1 style={{ fontSize: '3.5rem', fontWeight: '900', margin: '15px 0 0 0', color: 'white' }}>
          شقق <span style={{ color: '#f59e0b' }}>رام الله</span>
        </h1>
        <p style={{ color: '#888', marginTop: '10px', fontSize: '1.1rem' }}>دليلك العقاري الأول في فلسطين</p>
      </div>

      {/* حقل إدخال الكود السري */}
...
// --- التنسيقات الفخمة للثيم الأسود ---

const containerStyle = {
  backgroundColor: '#000', // خلفية سوداء عميقة
  color: 'white',
  minHeight: '100vh',
  display: 'flex',
...
const logoContainerStyle = {
  ...
  alignItems: 'center',
  justifyContent: 'center',
  boxShadow: '0 0 50px rgba(245, 158, 11, 0.1)' // توهج خفيف ذهبي خلف اللوجو
};
