...
export default function App() {
  ...
  return (
    <div style={containerStyle}>
      ...
      {!isLoggedIn && (
        /* قسم مواقع التواصل: أيقونات سادة على خلفية سوداء بحدود سميكة */
        <div style={socialGrid}>
          
          {/* واتساب - شعار رسمي سادة */}
          ...
          {/* فيسبوك - شعار رسمي سادة ودائري (الأفضل والأحدث) */}
          <a href="https://facebook.com/shoqaq.store/" target="_blank" rel="noreferrer" style={iconBoxStyle}>
            <svg width="24" height="24" fill="#1877F2" viewBox="0 0 24 24">
              <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm3 8h-1.35c-.538 0-.65.221-.65.778V10h2l-.209 2H13v7h-3v-7H8v-2h2V7.692C10 5.923 10.931 5 13 5h2v3z"/>
            </svg>
          </a>

          {/* انستغرام - أيقونة سادة */}
...
const identitySection = {
  textAlign: 'center',
  marginBottom: '20px', // تقليل المسافة العلوية قليلاً
  display: 'flex',
  flexDirection: 'column',
  alignItems: 'center'
};
...
const logoWrapper = {
  ...
  alignItems: 'center',
  justifyContent: 'center',
  border: '2px solid #222', // حدود سميكة وواضحة (كما طلبت)
  width: '90px',
  height: '90px'
};
...
const subTitle = {
  color: '#888', // خط تابعونا الآن واضح وفخم
  marginTop: '8px',
  fontSize: '1.2rem',
  fontWeight: '500'
};
...
const iconBoxStyle = {
  ...
  justifyContent: 'center',
  textDecoration: 'none',
  backgroundColor: '#000', // خلفية سوداء للأيقونة
  border: '2px solid #222' // حدود سميكة وواضحة (كما طلبت)
};
...
const serviceCardStyle = { 
  ...
  gap: '20px', 
  padding: '22px 25px', 
  backgroundColor: '#000', // خلفية سوداء للبطاقة
  border: '2.5px solid #222', // حدود سميكة وواضحة (كما طلبت) لخدمات تبرز
  borderRadius: '18px',
  cursor: 'pointer', 
  textAlign: 'right', 
  width: '100%', 
