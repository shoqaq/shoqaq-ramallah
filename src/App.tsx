...
import { Phone, Facebook, Instagram, LogOut, PlusCircle, LayoutDashboard, Building2, ClipboardEdit } from 'lucide-react';
...
const s = {
  ...
  title: { fontSize:'2rem', fontWeight:'900', margin:'10px 0 0 0' },
  sub: { color:'#888', marginTop:'8px', fontSize:'1.1rem', fontWeight:'400' },
  
  // تنسيق الخدمات الجديد
  services: { display:'flex', flexDirection:'column', gap:'15px', width:'100%', maxWidth:'320px', marginBottom:'40px' },
  serviceCard: { 
    display:'flex', alignItems:'center', gap:'15px', padding:'20px', 
    backgroundColor:'#0a0a0a', border:'1px solid #1a1a1a', borderRadius:'16px',
    cursor:'pointer', transition:'0.2s', textAlign:'right'
  },
  serviceText: { color:'white', fontSize:'1.1rem', fontWeight:'600' },
