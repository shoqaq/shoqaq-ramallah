...
>
  ...
  {/* السماعة (نسخة متوازنة من مصدر رسمي مبسّط) */}
  <path
    d="M15.2 14.1c-.2.4-.6.7-1 .8-.3.1-.6.1-.9 0-.5-.2-1-.4-1.4-.7-.7-.5-1.3-1.1-1.8-1.8-.5-.6-.9-1.3-1.2-2-.2-.4-.3-.8-.3-1.2 0-.3.1-.6.2-.9.2-.4.6-.7 1-.8.2-.1.4-.1.6 0 .2.1.3.2.4.4l.5 1c.1.2.1.4 0 .6l-.3.4c-.1.1-.1.2 0 .3.3.5.6.9 1 1.2.4.4.8.6 1.3.9.1 0 .2.1.3.1.1 0 .2 0 .3-.1l.4-.3c.2-.2.5-.2.7 0l1 .5c.2.1.3.2.4.4.1.2.1.4 0 .6z"
    fill="#22c55e"
  />
</svg>
</a>
