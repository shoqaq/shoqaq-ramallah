...
>
  ...
  >
    ...
    {/* السماعة - مصغرة ومتمركزة */}
    <path
      d="M14.9 13.3c-.2.4-.5.7-.9.8-.3.1-.6.1-.9 0-.5-.1-1-.4-1.5-.7-.7-.5-1.3-1.1-1.8-1.8-.4-.6-.8-1.2-1-1.9-.1-.3-.2-.6-.2-.9 0-.3.1-.6.2-.8.2-.4.5-.7.9-.8.2-.1.4-.1.6 0 .2.1.3.2.4.4l.5 1c.1.2.1.4 0 .6l-.2.3c-.1.1-.1.2 0 .3.2.4.6.8.9 1.1.4.3.8.6 1.2.8.1 0 .2.1.3 0l.3-.2c.2-.2.4-.2.6 0l1 .5c.2.1.3.2.4.4.1.3.1.5 0 .7z"
      fill="#22c55e"
    />
  </svg>
</a>
