...
>
  ...
  >
    ...
    <path
      fill="#22c55e"
      d="M15.6 13.8c-.2.5-.6.9-1.1 1-.3.1-.6.1-.9 0-.5-.2-1-.4-1.4-.7-.7-.5-1.4-1.1-1.9-1.8-.5-.6-1-1.3-1.3-2.1-.2-.4-.3-.8-.3-1.2 0-.3.1-.7.3-1 .2-.5.7-.9 1.2-1 .3-.1.5-.1.8 0 .2.1.4.2.5.4l.6 1.2c.1.3.1.6 0 .9l-.3.4c-.1.1-.1.2 0 .3.3.5.7 1 1.2 1.4.4.4.9.7 1.4 1 .1 0 .2.1.3.1.1 0 .2 0 .3-.1l.4-.3c.3-.2.7-.2 1 0l1.2.6c.2.1.4.3.5.5.1.2.1.4 0 .6z"
    />
  </svg>
</a>
