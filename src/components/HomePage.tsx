...
>
  ...
  >
    {/* الفقاعة */}
    <path
      d="M12 2a10 10 0 0 0-8.7 15L2 22l5.2-1.3A10 10 0 1 0 12 2z"
      fill="none"
      stroke="#22c55e"
      strokeWidth="1.7"
      strokeLinecap="round"
    ...
    {/* السماعة (مطابقة أكثر للشكل الحقيقي) */}
    <path
      d="M16.7 14.4c-.3.8-.9 1.3-1.6 1.5-.5.1-1 .1-1.4 0-.7-.2-1.4-.5-2-.9-1.1-.7-2-1.6-2.8-2.7-.7-.9-1.3-2-1.7-3.1-.2-.6-.4-1.1-.4-1.7 0-.5.1-1 .3-1.4.3-.8.9-1.3 1.6-1.5.4-.1.8-.1 1.2 0 .3.1.6.4.8.7l.9 1.7c.2.5.2 1 0 1.4l-.5.7c-.1.2-.1.3 0 .5.5.9 1.1 1.7 1.9 2.4.7.6 1.5 1.1 2.4 1.5.2.1.3.1.5 0l.7-.5c.5-.3 1-.3 1.4 0l1.7.9c.3.2.6.5.7.8.2.4.2.9 0 1.3z"
      fill="#22c55e"
    />
  </svg>
</a>
